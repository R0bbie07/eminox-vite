...
const CASES = [
  { num: '01', client: 'Transport for London', year: '2017—2020', sector: 'On-road · Metropolitan bus', headline: "We rebuilt the lungs of London's bus network.", stats: [['5,000+','Buses'],['>65%','Share'],['£86.1m','Programme'],['90%','NOx cut']] },
  { num: '02', client: 'First Group Scotland',  year: '2022—2023', sector: 'On-road · LEZ compliance',  headline: "205 buses readied for Scotland's first LEZ rollout.", stats: [['205','Buses'],['4','Cities'],['LEZ','Compliant'],['Zero','Disruption']] },
  { num: '03', client: 'Porterbrook',           year: 'Ongoing',   sector: 'Rail · Diesel multiple unit', headline: 'The first UK rail aftertreatment retrofit.', stats: [['1st','UK rail'],['DMU','Class'],['ORR','Certified'],['2','Follow-ons']] },
  { num: '04', client: 'International',         year: '2008—2017', sector: 'On-road · Global',          headline: '3,000 SCRT® systems across six markets.', stats: [['~3,000','Systems'],['6','Markets'],['JM','Verified'],['EU','Certified']] },
  { num: '05', client: 'Power Generation',      year: '2020—Present', sector: 'Stationary · MCPD',     headline: 'Genset retrofit without rip-and-replace.', stats: [['40—560kW','Retrofit'],['MCPD','Directive'],['AMPS','Member'],['5MW','Capability']] },
];
    ...
    <section id="work" style={{ padding: 'var(--section-py) var(--section-px)', background: 'hsl(0 0% 5%)' }}>
      <div style={{ maxWidth: 1440, margin: '0 auto' }}>
        <Reveal>
          ...
          <p style={{ fontSize: 16, color: 'rgba(243,237,228,0.65)', maxWidth: 520, lineHeight: 1.6, marginBottom: 80 }}>
            The work behind the numbers. From the £86.1m Transport for London retrofit to the Scottish LEZ programme.
          </p>
        </Reveal>
          ...
          {CASES.map((c, i) => (
            <Reveal key={c.num} delay={i * 0.04}>
              ...
              >
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16, paddingLeft: 24, borderLeft: '1px solid rgba(255,255,255,0.1)' }}>
                  {c.stats.map(([v, l], j) => (
                    <div key={j}>
      ...
      <style>{`
        @media (max-width: 768px) {
          .work-row { grid-template-columns: 60px 1fr !important; }
          .work-row > div:last-child { display: none; }
        }
      `}</style>
    </section>
  );
